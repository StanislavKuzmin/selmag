...
public class ProductController {
    ...
    @PostMapping("/edit")
    public String updateProduct(@ModelAttribute(value = "product", binding = false) Product product, @Valid UpdateProductPayload payload, BindingResult result, Model model) {
        if (result.hasErrors()) {
