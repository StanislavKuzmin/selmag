...
class ProductsRestControllerIT {
    ...
    void createProduct_RequestIsValid_ReturnsNewProduct() throws Exception {
        ...
        var requestBuilder = MockMvcRequestBuilders.post("/catalogue-api/products")
                ...
                .content("""
                        {"title": "Еще один новый товар", "details": "Описание нового товара"}""")
        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andExpectAll(
                        ...
                        content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON),
                        content().json("""                      
                                {"id" : 1, "title": "Еще один новый товар", "details": "Описание нового товара"}
                                """));
    }

    @Test
    void createProduct_RequestIsInvalid_ReturnsProblemsDetail() throws Exception {
        //given
        var requestBuilder = MockMvcRequestBuilders.post("/catalogue-api/products")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
